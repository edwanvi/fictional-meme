...
public class ItemTestCloak extends Item implements IBauble, IRenderBauble {
    ...
    private static final ResourceLocation texture = new ResourceLocation(
            "testmodpleaseignore:textures/models/idunncloak.png");
    ...
    public void onPlayerBaubleRender(ItemStack stack, EntityPlayer player, RenderType type, float partialTicks) {
        if (type == RenderType.BODY) {
			...
			/*
             * int light = 15728880; int lightmapX = light % 65536; int
			 * lightmapY = light / 65536;
			 * OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.
			 * lightmapTexUnit, lightmapX, lightmapY);
			 * Minecraft.getMinecraft().renderEngine.bindTexture(
			 * getCloakGlowTexture()); model.render(1F);
			 */
        }
    }
