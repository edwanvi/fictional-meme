...
public class Brewing {
	 ...
	 * @param fromType
	 *            The type of potion this will be brewed from. Ex water in water
	 *            -> Awkward.
	 * @param normalType
	 *            The output potion. This is the effect that will be used for a
	 *            potion that has not had redstone/glowstone/other modifiers
	 *            applied.
	 * @param longType
	 *            The potion type to use if the potion has been lengthened with
	 *            Redstone.
	 * @param strongType
