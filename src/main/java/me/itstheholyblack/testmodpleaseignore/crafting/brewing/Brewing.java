...
public class Brewing {
    ...
    private static final Predicate<ItemStack> GLOWSTONE_PREDICATE = potionPredicate(
     ...
     * @param fromType   The type of potion this will be brewed from. Ex water in water
     *                   -> Awkward.
     * @param normalType The output potion. This is the effect that will be used for a
     *                   potion that has not had redstone/glowstone/other modifiers
     *                   applied.
     * @param longType   The potion type to use if the potion has been lengthened with
     *                   Redstone.
     * @param strongType The potion type to use if the potion has been strengthened
     *                   with Glowstone.
     * @author wiresegal
     */
    public static void addCompletePotionRecipes(Predicate<ItemStack> predicate, PotionType fromType,
        ...
        if (longType != null)
            MethodHandles.registerPotionTypeConversion(normalType, REDSTONE_PREDICATE, longType);
        if (strongType != null)
            MethodHandles.registerPotionTypeConversion(normalType, GLOWSTONE_PREDICATE, strongType);
    }

    public static void addPotionConversionRecipes(Predicate<ItemStack> predicate, PotionType fromTypeNormal,
                                                  @Nullable PotionType fromTypeLong, @Nullable PotionType fromTypeStrong, PotionType normalType,
                                                  @Nullable PotionType longType, @Nullable PotionType strongType) {
