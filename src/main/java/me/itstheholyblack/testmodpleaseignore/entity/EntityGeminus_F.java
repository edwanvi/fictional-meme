...
public class EntityGeminus_F extends EntityMob implements IMob, IRangedAttackMob {
    ...
    public void onLivingUpdate() {
        ...
        if (closestPlayer != null) {
            if (this.closestPlayer.getDistanceSqToEntity(this) < 10.0D && !this.closestPlayer.isPotionActive(MobEffects.BLINDNESS)) {
     ...
     *
     * @param target The entity this missile will follow.
     */
